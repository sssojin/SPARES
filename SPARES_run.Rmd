...
# - BCRF_coef : BCRF coefficients for random forest model(lm model: BCRF=NULL)
...
reg_model='rf' # you can choose among rf, lin
EoR_seed=1886
...
```{r}
fit_model = Ftn_fit_mdl(reg_model='rf', data = Imputed_dat, y_var='eventtime', status_var='status', BCRF_coef=BCRF_coef)
mdl = fit_model$mdl
